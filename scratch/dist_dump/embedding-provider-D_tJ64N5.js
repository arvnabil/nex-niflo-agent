...
import { c as resolveOllamaApiBase } from "./provider-models-DyhFa3ck.js";
//#region extensions/openai/src/embedding-provider.ts
...
function resolveOllamaApiKey(options) {
	...
	const providerApiKey = normalizeOptionalSecretInput(options.config.models?.providers?.openai?.apiKey);
	if (providerApiKey) return providerApiKey;
	return resolveEnvApiKey("openai")?.apiKey;
}
