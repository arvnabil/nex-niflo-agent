import { m as ensureModelAllowlistEntry, n as applyAgentDefaultModelPrimary } from "./provider-onboard-CghzCQ2p.js";
//#region extensions/openai/default-models.ts
const OPENAI_DEFAULT_MODEL = "openai/mistral:7b";
const OPENAI_CODEX_DEFAULT_MODEL = "openai/mistral:7b";
...
function applyOpenAIProviderConfig(cfg) {
	...
	models[OPENAI_DEFAULT_MODEL] = {
		...models[OPENAI_DEFAULT_MODEL],
		alias: models["openai/mistral:7b"]?.alias ?? "GPT"
	};
	return {
		...next,
		agents: {
